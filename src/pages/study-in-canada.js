...
export default function Canada() {
  return (
    <>
      <Head>
        <title>
          Let Brainstrom Education help you get your Abroad Study Visa to Canada
        </title>
        <meta
          name="Description"
        ...
        <meta
          property="og:title"
          content="Let Brainstrom Education help you get your Abroad Study Visa to Canada"
        />
        <meta
      ...
      <Navbar></Navbar>
      <TopSection
        title="Study In Canada with Brainstrom Global Education"
