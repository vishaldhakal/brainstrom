...
export default function Australia() {
  return (
    <>
      <Head>
        <title>
          Let Brainstrom Education help you get your Abroad Study Visa to
          Australia
        </title>
        <meta
          name="Description"
        ...
        <meta
          property="og:title"
          content="Let Brainstrom Education help you get your Abroad Study Visa to Australia"
        />
        <meta
      ...
      <Navbar></Navbar>
      <TopSection
        title="Study In Australia with Brainstrom Global Education"
