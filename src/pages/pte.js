...
export default function Contact() {
  return (
    <>
      <Head>
        <title>
          Brainstrom provide PTE classes for students applying to Australia
        </title>
        <meta
          name="Description"
        ...
        <meta
          property="og:title"
          content="Brainstrom provide PTE classes for students applying to Australia"
        />
        <meta
      ...
      <Navbar></Navbar>
      <TopSection
        title="Study PTE With Brainstrom Education"
