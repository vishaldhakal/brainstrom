...
export default function Contact() {
  return (
    <>
      <Head>
        <title>
          Brainstrom provide IELTS classes for students applying to Australia
        </title>
        <meta
          name="Description"
        ...
        <meta
          property="og:title"
          content="Brainstrom provide IELTS classes for students applying to Australia"
        />
        <meta
      ...
      <Navbar></Navbar>
      <TopSection
        title="Study IELTS With Brainstrom Education"
