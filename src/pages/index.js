...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>
          Brainstrom Global Education and Visa Services - Kathmandu, Nepal
        </title>
        <meta
          name="Description"
          ...
          <div className="col order-2 order-md-1">
            <div className="mt-4">
              ...
              <h1 className="main-title mt-3">
                Get the Education You Deserve: Study in the World's Top
                Destinations
              </h1>
              <p className="mt-2">
                Empower your future with Brainstorm - a youth-focused,
                authentic, timely, responsible, and instant solution for abroad
                education. Let us help you achieve your goals and unlock your
                potential.
              </p>
      ...
      <div>
        <h2 className="fw-bb fs-1 text-center">Services Brainstrom Offers</h2>
      ...
      <div className="bggg">
        <section className="container py-3">
          <div className="row row-cols-1 row-cols-md-2 align-items-center">
            ...
            <div className="col">
              <span className="box-Brainstrom2 p-3 fw-bold shadow-lg">
                About Brainstrom Global Education & Visa Services
              </span>
              <br />
              <br />
              <br />
              ...
              <p className="mt-4">
                Brainstrom Global Education is one of the emerging pioneer
